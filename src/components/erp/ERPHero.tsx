...
const stats = [
  { value: "150+", label: "ERP Implementations" },
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-hero-foreground leading-[1.08] mb-6">
                Turn Operations Into a{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-orange-300">
                  Competitive Advantage
                </span>
              </h1>
              <p className="text-hero-foreground/50 text-sm sm:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
                AI-driven ERP platforms that unify finance, supply chain, HR, and commerce into one intelligent system, with predictive analytics, automated workflows, and real-time decision intelligence that cut costs by 45% and accelerate growth.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                <a href="#lead-capture" className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-full font-semibold text-sm hover:bg-primary/90 transition-all hover:gap-3">
                  Get Your ERP Transformation Roadmap <ArrowRight className="w-4 h-4" />
                </a>
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center">
                {["AI-Powered Decision Intelligence", "Predictive Analytics Built-In", "EKASYS & MEDOC Proprietary Platforms"].map((item) => (
