...
const services = [
  {
    ...
    desc: "Intelligent conversational agents that handle customer support, qualify leads, and deliver personalized experiences 24/7.",
    link: "/ai-chatbots",
  },
  {
    title: "Process Automation & Workflows",
    desc: "Streamline repetitive tasks with smart automation, from data entry to order processing, saving time and reducing errors.",
    link: "/process-automation",
  },
  {
    title: "Predictive Analytics & Insights",
    desc: "Leverage machine learning to forecast trends, optimize inventory, and make data-driven decisions that accelerate growth.",
    ...
    <section className="py-8 sm:py-14 bg-background">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-violet-500/10 rounded-full blur-[180px]" />
          <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-cyan-500/8 rounded-full blur-[150px]" />
          ...
          <div className="relative z-10 p-6 sm:p-10 md:p-16 lg:p-20 flex flex-col lg:flex-row gap-8 sm:gap-12 lg:gap-16 sm:min-h-[600px]">
            ...
            <div className="flex-1 flex flex-col justify-center">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold text-white leading-[1.1] mb-6">
                ...
                Your Business
                <br />
                with <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">AI &</span>
                <br />
              ...
              <p className="text-white/60 text-lg max-w-md leading-relaxed mb-8 font-light">
                Harness the power of artificial intelligence and smart automation to streamline operations, 
