...
const packages = [
  {
    name: "Starter",
    price: "2,500",
    desc: "Launch your WordPress + WooCommerce store quickly with a premium theme and essential e-commerce features.",
    features: [
      "Premium WooCommerce Theme Setup",
      "Up to 50 Products",
      "Mobile-Responsive Design",
      "Basic SEO & Permalink Setup",
  ...
  },
  {
    name: "Growth",
    price: "10,000",
    desc: "Custom-designed WooCommerce store with advanced plugins, marketing integrations, and conversion optimization.",
    features: [
      "Custom UI/UX Design",
      "Up to 200 Products",
      "Advanced SEO & Speed Optimization",
      "Multi-Currency (WPML / WooCommerce Multi-Currency)",
  ...
  },
  {
    name: "Enterprise",
    price: "25,000",
    desc: "Fully custom WooCommerce store with multi-language, ERP integration, and enterprise-grade scalability.",
    features: [
  ...
  },
  {
    ...
    price: null,
    desc: "Enterprise-grade WooCommerce for complex businesses, headless, multi-vendor, B2B wholesale, and unlimited scale.",
    features: [
      "Headless WooCommerce (React / Next.js)",
      "Multi-Vendor Marketplace Setup",
      "Advanced B2B & Wholesale Features",
      "Custom REST API Development",
      "Multi-Store & Multi-Site Network",
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground leading-[1.1] mb-4">
            Transparent WooCommerce Development<br />Packages Starting From AED 2,500
          </h2>
          <p className="text-muted-foreground text-sm max-w-2xl mx-auto">
            Choose the package that fits your business stage. Every package includes dedicated support, quality assurance, and on-time delivery.
          </p>
        </motion.div>
          ...
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <div className="px-7 pb-5">
                <button
                  onClick={() => openContactDialog(`WooCommerce ${pkg.name}${pkg.price ? `, AED ${pkg.price}` : ''}`)}
...
export default WooPricingPackages;
