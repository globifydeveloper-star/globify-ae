...
const stats = [
  { value: "$120M+", label: "Revenue Engineered" },
  { value: "350+", label: "Growth Campaigns" },
  { value: "8.5x", label: "Average ROAS" },
  { value: "40%", label: "Lower CAC via AI" },
];
  ...
  return (
    <>
       <section className="relative pt-28 sm:pt-32 pb-16 sm:pb-24 bg-hero overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-[700px] h-[700px] bg-primary/8 rounded-full blur-[180px] pointer-events-none" />

        <div className="container mx-auto px-5 sm:px-6 relative z-10">
          <div className="max-w-3xl">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <p className="text-sm font-bold tracking-[0.3em] uppercase text-primary mb-5">AI-Driven Revenue Marketing</p>
              ...
              <p className="text-hero-foreground/50 text-sm sm:text-base leading-relaxed mb-8 max-w-2xl">
                AI-optimized, full-funnel marketing that turns every dollar into predictable revenue. From AI-powered campaign optimization and attribution intelligence to automated lead nurturing, we engineer growth, not just traffic.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-10">
                <a href="#lead-capture" className="inline-flex items-center justify-center gap-2 bg-primary text-primary-foreground px-8 py-4 rounded-full font-semibold text-sm hover:bg-primary/90 transition-all hover:gap-3">
                  Get Your AI Growth Audit <ArrowRight className="w-4 h-4" />
                </a>
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-2">
                {["AI Campaign Optimization", "Full-Funnel Attribution", "Marketing Automation at Scale"].map((item) => (
