...
const stats = [
  { value: "200+", label: "Products Engineered" },
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-hero-foreground leading-[1.08] mb-6">
                Engineer Digital Products That{" "}
              ...
              <p className="text-hero-foreground/50 text-sm sm:text-base leading-relaxed mb-8 max-w-2xl mx-auto">
                We build AI-integrated mobile apps, SaaS platforms, and enterprise applications that automate operations, personalize user experiences, and generate measurable business outcomes, from MVP to market leadership.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-10">
                ...
                >
                  Start Your Product Journey <ArrowRight className="w-4 h-4" />
                </a>
                <a
                  href="#lead-capture"
              ...
              <div className="flex flex-wrap gap-x-6 gap-y-2 justify-center">
                {["AI-First Architecture", "Scalable Cloud-Native Platforms", "Integrated with ERP · CRM · Analytics"].map((item) => (
